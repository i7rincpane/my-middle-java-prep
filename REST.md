...
* ### [Шесть принципов REST (Рой Филдинг)](#шесть-принципов-rest-рой-филдинг)
* ### [Модель зрелости Ричардсона (Richardson Maturity Model)](#модель-зрелости-ричардсона)
* ### [Практика проектирования REST API](#практика-проектирования-rest-api)
* ### [Пример эталонного RESTful контроллера](#пример-эталонного-restful-контроллера)

## Шесть принципов REST (Рой Филдинг)
...
> **Ключевой момент:** REST — это **передача «представления» состояния** ресурса.
...
## Пример эталонного RESTful контроллера
