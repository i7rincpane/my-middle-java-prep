# OOP
* ### [Абстрактные классы и Интерфейсы: Фундаментальные отличия](#abstract-vs-interfaces-p)

## <a id="abstract-vs-interfaces-p">Абстрактные классы и Интерфейсы: Фундаментальные отличия</a>
