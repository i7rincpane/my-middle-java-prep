...
* ### [Процесс и Поток (Основы ОС)](#процесс-и-поток-основы-ос)
* ### [Java Memory Model](#jmm-java-memory-model)


## Процесс и Поток (Основы ОС)

> **Ключевой момент:** Процессы изолированы ради **безопасности** (защита данных), а потоки делят общую память ради **скорости**. Изоляция процессов реализуется через механизм **Виртуальной памяти**.
...
<a id="data_and_race_condition"></a>
