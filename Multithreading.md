...
> Ключевое: JMM предупреждает о DATA RACE конфликтах, связанных с оптимизациями (переупорядочивание или кэширование). В результате них потоки могут не видеть изменения друг друга. JMM описывает правила, которые позволяют этих конфликтов избегать.
